...
## Tableau Dashboard
The Sales Dashboard for Customer Segmentation can be found here.<br>
...
- [RFM Analysis.ipynb](https://nbviewer.jupyter.org/github/VishalKrish70/Data-Analytics-Customer-Segmentation/blob/master/RFM%20Analysis.ipynb)
...
## Authors
- Vishal R R - [Github Profile](https://github.com/VishalKrish70)
